# Metadata Extractor Prompt — English query → commercial catalogue filters

Extracts metadata filters from the translated English query into JSON. Extraction
only — never answers, retrieves, or explains.
